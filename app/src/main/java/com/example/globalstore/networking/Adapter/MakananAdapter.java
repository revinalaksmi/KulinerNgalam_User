...
import com.example.globalstore.networking.LayarDetail;
...
// .mPhotoURL);
            Glide.with(holder.itemView.getContext()).load(R.drawable.a).into(holder
                    .mImage);
        }
    ...
    public class MakananViewHolder extends RecyclerView.ViewHolder {
        ...
        public MakananViewHolder(View itemView) {
            ...
            tvMenu =(TextView) itemView.findViewById(R.id.tvNama);

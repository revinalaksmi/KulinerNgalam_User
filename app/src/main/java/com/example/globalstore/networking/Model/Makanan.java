...
public class Makanan {
    ...
    public Makanan(String idMakanan, String menu, String kategori, String harga, String alamat,
                   String review, String tanggal, int suka, int komentar, String gambar, String
            action) {
